...
/* ── Featured Card (with red hover overlay) ── */
...
/* ── Standard Collection Card (with red hover overlay) ── */
...
/* ── Build metadata spans: "5 Colors  3 Sizes  2 Finishes" ── */
function MetaSpans({ collection }: { collection: any }) {
  const parts: string[] = []
